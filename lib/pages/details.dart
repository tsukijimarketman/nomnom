      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  Text("Krabby Patty", style: AppWidget.HeadlineTextFieldStyle(),),
            ...
            SizedBox(height: 20,),
            Text("The sandwich comprises two buns, with the patty, lettuce, cheese, onions, tomatoes, ketchup, mustard, and pickles between them (in that order).", style: AppWidget.SoftTextFieldStyle(), textAlign: TextAlign.justify,),
            SizedBox(height: 30,),
            Row(
              children: [
